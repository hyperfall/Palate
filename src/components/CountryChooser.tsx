  ...
  return (
    <label className={`flex items-center gap-2 ${className}`}>
      ...
      <select
        ...
        className="max-w-[11rem] cursor-pointer truncate rounded border border-milk/40 bg-transparent px-2 py-1 font-mono text-caption text-milk hover:border-flame focus:border-flame focus:outline-none"
      >
